...
- (void)setUpChildViewController
{
    ...
    MSD_MVVM_ViewController * MVVMC = [[MSD_MVVM_ViewController alloc] init];
    
    UINavigationController * MVVMCNav = [[UINavigationController alloc] initWithRootViewController:MVVMC];
    
    [self addChildViewController:MVVMCNav title:@"" normalImage:@"tabbar_icon01" selectedImage:@"tabbar_icon01_fill"];
